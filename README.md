...
The [Cleveland Music Co. Hothouse](https://clevelandmusicco.com/hothouse-diy-digital-signal-processing-platform-kit/) is a DIY pedal kit for the [Electrosmith Daisy Seed](https://electro-smith.com/products/daisy-seed). You can use the Hothouse to easily get your Daisy Seed DSP projects off the breadboard and onto your pedalboard, either by compiling and flashing any of the code in this repository, or by using the [Hothouse Flasher](https://clevelandmusicco.github.io/HothouseFlasher/) with the binaries from [the latest release](https://github.com/clevelandmusicco/HothouseExamples/releases). And of course, you can also [write your own DSP code](https://github.com/clevelandmusicco/HothouseExamples/wiki/Creating-your-own-effects) for the Hothouse, using C++, Arduino, Puredata/Plugdata, Max/MSP Gen~, and more. Helper scripts for [boot-strapping new effects](https://github.com/clevelandmusicco/HothouseExamples/wiki/Creating-your-own-effects#using-create_new_projpy), [building all the examples](https://github.com/clevelandmusicco/HothouseExamples/wiki/Using-the-build_examples.py-helper-script), and a [VS Code Dev Container](https://github.com/clevelandmusicco/HothouseExamples/wiki/Using-the-VS-Code-Dev-Container) configuration is included.

> [!TIP]
> **YES, THE HOTHOUSE IS COMPATIBLE WITH THE [SEED3!](https://docs.daisy.audio/hardware/Seed3/)**
...
This project is a collection of digital signal processing code examples that you can use to get started with the Hothouse. In the `src` directory are ready-to-compile effects you can flash to your Hothouse or modify as you wish. Also included is a [helper script](https://github.com/clevelandmusicco/HothouseExamples/wiki/Creating-your-own-effects) that creates a compilable, VS Code-ready "scaffolding" project for writing your own effects for the Hothouse from scratch.

If you're not familar with the Daisy Seed or its development environment, check out the [Electrosmith Daisy Ecosystem Wiki](https://github.com/electro-smith/DaisyWiki/wiki) to get yourself bootstrapped! Also be sure to bookmark the [Daisy Forum](https://forum.electro-smith.com/) and join the [Discord server](https://discord.gg/ByHBnMtQTR) to hang out with like-minded people committed to collective learning.
...
* [**List of Hothouse Examples**](https://github.com/clevelandmusicco/HothouseExamples/wiki/Hothouse-Examples) - A growing list of available examples, loosely-organized and with brief descriptions.
...
* [**Using the VS Code Dev Container**](https://github.com/clevelandmusicco/HothouseExamples/wiki/Using-the-VS-Code-Dev-Container) - Automated toolchain setup and isolated build environment in the VS Code IDE.
* [**Taking the Wampler Pedals Digital Pedal Course?**](https://github.com/clevelandmusicco/HothouseExamples/wiki/Using-the-Hothouse-With-Wampler-Pedals-'Build-Digital-Guitar-Effects'-Course) - Learn how to make the course examples (developed in Faust) to run on the Hothouse.
